...
<style>
    ...
    .portal-container { display: flex; flex-direction: column; align-items: center; justify-content: center; height: 65vh; text-align: center; }
    .portal-title { font-size: 3rem; font-weight: 700; letter-spacing: -0.03em; color: #ffffff; margin-bottom: 0.5rem; }
    .portal-subtitle { font-size: 1.1rem; color: #94a3b8; font-weight: 500; margin-bottom: 3rem; }
</style>
